  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm border-b border-orange-100">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center space-x-2 sm:space-x-3 flex-shrink-0">
            ...
            <div className="relative">
              <div className="w-14 h-14 sm:w-12 sm:h-12 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg transition-transform duration-300">
                <div className="relative">
            ...
            <div className="flex flex-col">
              <span className="text-xl sm:text-2xl font-black bg-gradient-to-r from-orange-700 via-orange-800 to-orange-900 bg-clip-text text-transparent tracking-tight">
                WEB DESIGN BUNNY
              </span>
            </div>
          </Link>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <nav className="md:hidden mt-4 py-4 border-t border-orange-100 bg-white/95 backdrop-blur-sm rounded-lg shadow-sm">
            <div className="flex flex-col space-y-3 px-2">
              ...
              <div className="flex flex-col space-y-2 pt-3 border-t border-orange-100">
                <Link to="/login">
                  <Button variant="outline" className="w-full border-orange-200 text-orange-600 hover:bg-orange-50" onClick={() => setIsMenuOpen(false)}>
                    Client Login
                  </Button>
                </Link>
                <Link to="/register">
                  <Button className="w-full bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white" onClick={() => setIsMenuOpen(false)}>
                    <Rabbit className="w-4 h-4 mr-2" />
                    Get Started
                  </Button>
                </Link>
