        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 border border-orange-200">
              ...
              <span className="text-sm font-medium text-orange-700">Beautiful designs, affordable prices</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/register">
                <Button size="lg" className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              ...
              <a href="#portfolio">
                <Button variant="outline" size="lg" className="border-2 border-orange-300 text-orange-700 hover:bg-orange-50 text-lg px-8 py-6 rounded-full">
                  View Portfolio
                </Button>
              </a>
            </div>
            ...
            <div className="flex items-center space-x-8 pt-4">
              <div className="text-center">
                <div className="text-3xl font-bold text-orange-700">200+</div>
          ...
          <div className="relative">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-3 bg-orange-50 rounded-lg">
                    ...
                    <div className="text-orange-600 font-bold">From $1000</div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-orange-50 rounded-lg">
                    ...
                    <div className="text-orange-600 font-bold">$200/mo</div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-orange-50 rounded-lg">
                    ...
                    <div className="text-orange-600 font-bold">$500/mo</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Floating elements */}
            <div className="absolute -top-4 -right-4 w-14 h-14 bg-gradient-to-br from-orange-700 to-orange-800 rounded-full flex items-center justify-center shadow-lg animate-bounce z-20">
              <Rabbit className="w-6 h-6 text-white" />
            </div>
            
            {/* New bouncing bunny element at left bottom */}
            <div className="absolute -bottom-4 -left-4 w-14 h-14 bg-gradient-to-br from-orange-700 to-orange-800 rounded-full flex items-center justify-center shadow-lg animate-bounce z-20">
              <Rabbit className="w-6 h-6 text-white" />
            </div>
          </div>
        </div>
