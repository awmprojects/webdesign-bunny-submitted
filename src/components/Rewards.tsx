...
const Rewards = () => {
  const packages = [
    ...
    { name: "Business Website", icon: Code, color: "from-orange-500 to-violet-500", price: "$5,000", features: "10 pages, custom design, contact forms" },
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-50 rounded-3xl p-8 shadow-2xl border-4 border-orange-200 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-4">
                <div className="bg-orange-600 text-white px-4 py-2 rounded-full font-bold text-sm flex items-center space-x-2">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                <div className="text-center lg:text-left">
                  <div className="flex items-center justify-center lg:justify-start space-x-4 mb-4">
                    <div className="text-5xl font-bold text-orange-700">$1,000</div>
                ...
                <div className="text-center">
                  <Link to="/register">
                    <Button 
                      size="lg" 
                      className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-bold text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                    >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {packages.map((pkg, index) => (
            <div 
              key={index}
              className="group bg-gradient-to-br from-gray-50 to-white rounded-2xl p-6 border border-gray-200 hover:border-orange-300 hover:shadow-lg transition-all duration-300 cursor-pointer"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {addOns.map((addon, index) => (
              <div key={index} className="bg-white rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-shadow">
                <div className="text-2xl font-bold text-orange-600 mb-2">{addon.price}</div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg inline-block">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  ...
                  <div className="text-orange-600 font-bold text-lg">Discuss Your Project</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mt-8 lg:mt-16">
          <Link to="/register">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white text-base lg:text-lg px-8 lg:px-12 py-4 lg:py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 w-full sm:w-auto"
            >
