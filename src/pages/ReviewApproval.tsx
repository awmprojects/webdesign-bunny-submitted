...
import { Star, CheckCircle, XCircle, Eye, Clock, Package } from "lucide-react";
...
const ReviewApproval = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Review Approval</h1>
          <p className="text-gray-600">Manage and approve user-submitted reviews</p>
        </div>
